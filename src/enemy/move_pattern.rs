...
impl MovePattern {
	...
	pub fn velocity_updater(&self) -> Box<dyn VelocityUpdater> {
		match self {
			...
			Self::DownStayLeftBottom => Box::new(down_stay_left_bottom::DownStayLeftBottomPatternVelocityUpdater),
			Self::DownStayRightBottom => Box::new(down_stay_right_bottom::DownStayRightBottomPatternVelocityUpdater),
